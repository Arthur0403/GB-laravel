...
@section('title', 'AZ News | Categories')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    ...
                                                    <div class="what-cap">
                                                        <span class="color1">Night party</span>
                                                        <h4><a href="/categories/welcome-to-the-night-party">Welcome To The Night Party</a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    ...
                                                    <div class="what-cap">
                                                        <span class="color1">Night party</span>
                                                        <h4><a href="/categories/another-title">Another title</a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                        ...
                        <div class="single-box">
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="/categories/welcome-to-the-best-model-winner-contest"><img src="/img/news/icon-fb.png" alt=""></a>
                                </div>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="/categories/welcome-to-the-best-model-winner-contest"><img src="/img/news/icon-tw.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                                    <p>Fans</p>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="/categories/welcome-to-the-best-model-winner-contest"><img src="/img/news/icon-ins.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                                    <p>Fans</p>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="/categories/welcome-to-the-best-model-winner-contest"><img src="/img/news/icon-yo.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                                    <p>Fans</p>
